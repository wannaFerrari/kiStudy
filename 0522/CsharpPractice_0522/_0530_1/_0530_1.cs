...
namespace _0530_1
{
    ...
    internal class _0530_1
    {
        ...
        static void DrawEnemy(Point2D point)
        {
            Console.SetCursorPosition((point.x + 1) * X_SIZE, point.y + 1);
        ...
        static void StartGame()
        {
            ...
            int enemyX = mapWidth - 1;
            int enemyY = mapHeight - 1;
            int itemCount = 3;
            int obstacleCount = 3;
            Point2D playerPoint = new Point2D(playerX, playerY);
            Point2D enemyPoint = new Point2D(enemyX, enemyY);
